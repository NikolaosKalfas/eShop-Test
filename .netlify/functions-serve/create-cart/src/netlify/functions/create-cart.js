...
// netlify/functions/create-cart.js
__export(exports, {
  handler: () => handler,
  sendShopifyStorefrontRequest: () => sendShopifyStorefrontRequest
});
var import_node_fetch = __toModule(require_lib2());
var sendShopifyStorefrontRequest = async ({ query, variables }) => {
  const result = await (0, import_node_fetch.default)("https://nikosteststore.myshopify.com/api/2021-10/graphql.json", {
    method: "POST",
    headers: {
...
var handler = async () => {
  ...
  return {
    statusCode: 200,
    body: JSON.stringify({
      cartId: (_b = (_a = data.cartCreate) == null ? void 0 : _a.cart) == null ? void 0 : _b.id,
      checkoutUrl: (_c = data.cartCreate) == null ? void 0 : _c.cart.checkoutUrl
    })
  };
};
